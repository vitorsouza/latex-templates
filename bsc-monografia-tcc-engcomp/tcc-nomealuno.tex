% ==============================================================================
% Modelo para Monografia de Trabalho de Conclusão de Curso de Graduação para
% Engenharia de Computação (em Português)
%
% Prof. Vítor E. Silva Souza - NEMO/UFES :: DI/UFES :: PPGI/UFES
% Com adaptações feitas pelo Colegiado de Engenharia de Computação / CT / UFES 
% e pela profª. Monalessa Perini Barcellos (NEMO/UFES).
%
...
\preambulo{Monografia apresentada ao Curso de Engenharia de Computação do Centro Tecnológico da Universidade Federal do Espírito Santo, como requisito parcial para obtenção do Grau de Bacharel em Engenharia de Computação.}
