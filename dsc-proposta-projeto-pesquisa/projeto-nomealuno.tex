% ==============================================================================
% Modelo para Plano de Estudo no Exterior - PDSE/CAPES
...
\preambulo{Proposta de Projeto de Pesquisa apresentada como requisito para participação no processo de seleção para o Programa de Doutorado em Ciência da Computação da Universidade Federal do Espírito Santo.}
...
\input{secoes/sec2-referencial}
\input{secoes/sec3-objetivos}
\input{secoes/sec4-justificativas}
\input{secoes/sec5-metodologia}
\input{secoes/sec6-cronograma}
