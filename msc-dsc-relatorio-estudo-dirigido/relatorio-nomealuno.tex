% ==============================================================================
% Modelo para Relatório de Estudo Dirigido (em Português)
...
% (*) Como título, colocar o subtítulo do estudo dirigido (ex.: Engenharia de Ontologias).
\titulo{<<Título>>}
\autor{<<Nome do Estudante>>}
\local{Vitória, ES}
\data{<<mês/ano>>}
\orientador{<<Nome do orientador no PPGI>>}
\instituicao{
...
\tipotrabalho{Relatório de Estudo Dirigido}

% Preâmbulo (tipo do trabalho, objetivo, nome da instituição, área de concentração, etc.).
% (*) Indicar se é Estudo Dirigido I, II ou III.
\preambulo{Relatório entregue ao final da disciplina Estudo Dirigido <<I / II / III>> do Programa de Pós-Graduação em Informática da Universidade Federal do Espírito Santo, descrevendo o trabalho feito ao longo do semestre para avaliação do orientador e registro do próprio estudante.}
...
\input{secoes/sec1-introducao}
\input{secoes/sec2-visao}
\input{secoes/sec3-resultados}
\input{secoes/sec4-conclusoes}
