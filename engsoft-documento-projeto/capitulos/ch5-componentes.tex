...
\vitor{A partir da arquitetura da Figura~\ref{figura-arquitetura}, descrever no parágrafo acima os subsistemas e as camadas de cada subsistema que serão apresentadas, ajustando as subseções abaixo conforme necessário (os títulos das subseções deve ser os nomes dos subsistemas conforme arquitetura) e preenchendo-as com modelos e explicações textuais. Como exemplo, vide documento de projeto do Marvin.}
