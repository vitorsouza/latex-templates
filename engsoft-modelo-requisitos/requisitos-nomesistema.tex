...
\input{capitulos/ch2-estorias}
\vspace*{1.5cm}

\input{capitulos/ch3-subsistema}
\vspace*{1.5cm}

\input{capitulos/ch4-casodeuso}
\vspace*{1.5cm}

\input{capitulos/ch5-modeloestrutural}
\vspace*{1.5cm}

\input{capitulos/ch6-dicionario}
\endgroup
