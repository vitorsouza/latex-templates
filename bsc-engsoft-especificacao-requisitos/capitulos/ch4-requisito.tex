...
\vitor{Está sendo utilizado o \textit{template} que lista os requisitos funcionais. Existe também um \textit{template} para estórias de usuário, basta modificar o arquivo \texttt{ch4-} que está sendo incluído no documento principal.}
