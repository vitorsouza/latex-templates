...
\begin{quadro}[h]
	...
	\begin{tabular}{|p{2.7cm}|l|l|l|l|l|l|l|l|l|l|l|l|}
		...
		\hline
		a) Xxxx & \cellcolor{lightgray}  &   &   &    &  &   &   &   &   &   &   &  \\
		\hline
		b) Yyyy & \cellcolor{lightgray}  &   &   &   &   &   &    &    &   &   &   &  \\
		\hline
		c) Zzzzz &   &   &   &   &   &   &   &   &    &   &  & \\
		\hline
	\end{tabular}
	\caption*{Fonte: Produção do próprio autor.\\Nota: Atividade prevista (\fcolorbox{black}{lightgray}{\phantom{x}}),  atividade totalmente realizada (), atividade parcialmente realizada () e atividade não realizada ().}
\end{quadro}
