...
\begin{quadro}[h]
	...
	\begin{tabular}{|p{2.7cm}|l|l|l|l|l|l|l|l|l|l|l|l|}
		...
		\hline
	\end{tabular}
	\caption*{Fonte: Produção do próprio autor.\\Nota: atividade totalmente realizada (\totalmente), atividade parcialmente realizada (\parcialmente) e atividade não realizada (\naorealizada).}
